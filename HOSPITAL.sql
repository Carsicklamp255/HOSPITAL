...
('12345678901', 'João Silva', '1990-05-20', '21-998754', 'joao@example.com'),
...
/*select CPF_PACIENTE, NOME, DATA_NASC, TELEFONE, EMAIL
from PACIENTES*/ 
...
SELECT NOME D.NOME_ESPECIALIDADE NOME , COUNT(C.ID_CONSULTAS) QUANTDADE
FORM CONSULTAS C
INNER JOIN MEDICOS M ON C.CRM = M.CRM AND C.UF = M.OF
INNER JOIN DEPARTAMENTOS D ON M.DEPTO_COD_ESPEC = D.COD_ESPECIALIDADE
GROP BY D.NOME_ESPECIALIDADE BASE
GORUP BY ESPECIALIDADE;
